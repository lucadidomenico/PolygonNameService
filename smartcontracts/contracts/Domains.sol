...
contract Domains  is ERC721URIStorage {
  ...
  // key of all of these mappings is always the dns name
  mapping(string => address) public domains;
  mapping(string => string) public records; // Checkout our new mapping! This will store values
  mapping(string => string) public emails;
  mapping(string => string) public websites; // web site of the owner
  ...
  event DomainMinted(string name, uint tokenId);
  ...
  function register(string calldata name) public payable {
    ...
    emit DomainMinted(name, newRecordId);
    _tokenIds.increment();
  }
  ...
  function setWebsite(string calldata name, string calldata website) public {
      require(domains[name] == msg.sender);
      websites[name] = website;
  }

  function getWebsite(string calldata name) public view returns(string memory) {
